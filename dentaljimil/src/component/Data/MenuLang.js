            ...
            <React.Fragment>
                <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                    ...
                    <Tooltip title="Account settings">
                        ...
                        >
                            <img alt='' style={{ height: '28px', width: '40px' }} src='https://dentalcam.app/static/media/ic_flag_en.9a67c937.svg' />
                        </IconButton>
                    </Tooltip>
                </Box>
                <Menu
                ...
                >
                    ...
                    <List>
                        ...
                        <ListItemButton>
                            <img alt='' style={{ height: '24px', width: "24px", borderRadius: '12px', objectFit: 'cover', margin: '0px 20px 0  10px' }} src='https://dentalcam.app/static/media/ic_flag_fr.7b5666a7.svg' />
