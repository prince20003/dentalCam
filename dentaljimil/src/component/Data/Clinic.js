    ...
    <>
                  ...
                  return val
                    ...
                    >
                      ...
                      <TableCell >
                        ...
                        <svg  onClick={()=>handleClickOpen(row.id)} className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-i4bv87-MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true" data-testid="DeleteIcon" style={{ color: 'red', cursor: 'pointer' }}><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"></path></svg>
                      </TableCell>
                    </TableRow>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleClosecl} autoFocus>
            Delete
          </Button>
        </DialogActions>
      </Dialog>
